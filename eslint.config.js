...
export default tseslint.config(
  {
    ignores: [
      ...
      "**/node_modules/**",
      "coverage/**",
      // Copied framework bundles for the docs playground (build artifacts,
      // like dist) — regenerated by scripts/build-playground-vendor.mjs.
      "docs/public/playground/vendor/**",
      "docs/.vitepress/dist/**",
