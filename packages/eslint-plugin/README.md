...
| ----------------------- | ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `no-impure-combinators` | error   | `fetch`/`localStorage`/`document`/setters/`dispatch`/`Date.now`/`Math.random` inside `accum`, `accumE`, `snapshot`, `lift2`, `lift3` callbacks — combinator functions must be pure |
