...
[@continuum-js/router](../index.md) / useParams

# Function: useParams()

> **useParams**(): `Behavior`\<[`Params`](../type-aliases/Params.md)\>

Defined in: [index.ts:102](https://github.com/denislibs/continuum/blob/d7c5ccacccc04163a481bd76c5d444925252087e/packages/router/src/index.ts#L102)
