...
**State**. A route change is a change of a dynamic region; leaving a page
...
state updates. The fine-grained promise, applied to routing.
...
const url = location(); // State<URL> — the singleton
```
