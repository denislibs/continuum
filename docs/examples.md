...
| **Router app** | Nested routes, layouts, params-as-Behavior, guards, `lazy` chunks       | [StackBlitz](https://stackblitz.com/github/denislibs/continuum/tree/main/examples/router-app) · [source](https://github.com/denislibs/continuum/tree/main/examples/router-app) |
